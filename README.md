...
| 2 | skman | Introduces the Agent Skills System — a standardized, lightweight, open format for extending AI agent capabilities with specialized knowledge and workflows. Use for scaffolding, validating, searching, and inspecting agent skills (SKILL.md files and other skill's files and directories). |
