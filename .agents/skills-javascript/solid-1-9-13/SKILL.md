...
license: MIT
compatibility: "Requires Node.js 18+ for build tooling. Browser support — ES2017+ (Chrome 62+, Firefox 58+, Safari 11.1+, Edge 79+). JSX transform via babel-preset-solid or @babel/plugin-transform-react-jsx."
