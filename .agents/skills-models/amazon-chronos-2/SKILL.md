...
- [03-fine-tuning](references/03-fine-tuning.md) — Fine-tuning strategies, LoRA config, data preparation with covariates, hyperparameter tuning, saving/loading
- [04-deployment](references/04-deployment.md) — AutoGluon-Cloud, SageMaker JumpStart, batch inference, endpoint configuration
- [05-advanced-usage](references/05-advanced-usage.md) — Embedding extraction, saving/loading pipelines
- [06-benchmarking](references/06-benchmarking.md) — fev benchmarking, available tasks, evaluation metrics
